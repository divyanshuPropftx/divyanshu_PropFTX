  ...
  return (
    ...
    <div className=' flex flex-row pt-24 gap-40 pl-24 pr-24'>
        ...
        <div className=' text-white flex flex-col justify-center'>
          ...
          <div className=' text-start font-medium text-xl leading-8 pt-4 whitespace-break-spaces '>PropFTX Market Place offers real estate investment options for short-term
