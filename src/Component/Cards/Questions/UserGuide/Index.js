...
function UserGuideFAQ() {
  return (
    <>
    <div className='text-white font-poppins pt-12 text-4xl font-semibold'>User Guide</div>
    <div className='flex font-poppins flex-col gap-6 pt-10 pl-24 pr-24 rounded-lg'>
    <div className='rounded-lg'><QuestionCard number="1" question="Why PropFTX (User Guide)" answer="Lorem ipsum dolor sit amet consectetur. Orci placerat condimentum ipsum etiam proin egestas. Maecenas pretium mattis risus lectus semper praesent nunc.Lorem ipsum dolor sit amet consectetur. Orci placerat condimentum ipsbhbu"/></div>
