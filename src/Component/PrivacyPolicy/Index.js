  ...
  return (
    <div className='parent font-poppins'>
      ...
      <div className=' text-white pl-32 pr-32 pt-12 flex flex-col'>
        ...
        <div className=' pt-6 text-lg font-bold text-start'>Collection of Information</div>
        ...
        <div className=' pt-6 text-lg font-bold text-start'>Use of Information</div>
        ...
        <div className=' pt-6 text-lg font-bold text-start'>Disclosure of Information</div>
        ...
        <div className=' text-sm font-normal text-start'>We may disclose your personal information to third parties for the following purposes:
          ...
          <div className=' pt-6 text-lg font-bold text-start'>Security</div>
          ...
          <div className=' pt-6 text-lg font-bold text-start'>Changes to This Privacy Policy</div>
          <div className=' pt-6 text-sm font-normal text-start'>
