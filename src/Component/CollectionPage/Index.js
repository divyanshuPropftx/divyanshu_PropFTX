  ...
  return (
    <div className='parent font-poppins'>
      ...
      <div className='bg-white'>
        <div className='text-black flex flex-row gap-20 p-2'>
          <div className='leftPaneCollection border border-pink text-black flex flex-col p-2'>
            <div className='border border-black text-black flex flex-row justify-between'>
            ...
            <div className='border border-black text-black flex flex-col pt-4'>
              <div className='border border-black text-lg font-bold text-start'>Property Phases</div>
              <div className='border border-black flex flex-row flex-wrap gap-2 p-2'>
                <button
                  className={`propertyPhasesButton border border-black text-black text-sm w-28 h-8 ${
                ...
                <button
                  className={`propertyPhasesButton border border-black text-black text-sm w-16 ${
            ...
            <div className='border border-black text-black flex flex-col pt-4'>
              <div className='border border-black text-lg font-bold text-start'>Sale Type</div>
              <div className='border border-black flex flex-row flex-wrap gap-2 p-2'>
                <button
                  className={`propertyPhasesButton border border-black text-black text-sm w-14 h-8 ${
                ...
                <button
                  className={`propertyPhasesButton border border-black text-black text-sm w-20  whitespace-nowrap ${
                ...
                <button
                  className={`propertyPhasesButton border border-black text-black text-sm w-24 whitespace-nowrap ${
            ...
            <div className='border border-black text-black flex flex-col pt-4'>
              <div className='border border-black text-lg font-bold text-start'>City</div>
              <div className='border border-black flex flex-row flex-wrap gap-2 p-2'>
            ...
            <div className='border border-black text-black flex flex-col pt-4'>
              <div className='border border-black text-lg font-bold text-start'>Builder's Name</div>
              <div className='border border-black flex flex-row flex-wrap gap-2 p-2'>
            ...
            <div className='border border-black text-black'>s</div>
            <div className='border border-black text-black'>s</div>
          </div>

          <div className='border border-black text-black'>section 2</div>
        </div>
      </div>
    </div>
  );
